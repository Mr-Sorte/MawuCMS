...
<div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
           <div class="kt-portlet__head-label">
              ...
              <h3 class="kt-portlet__head-title">Générer / changer un passe pour un staff</h3>
           </div>
        </div>
...
if(isset($_POST['staffname']) && isset($_POST['staffmail']))
{
    ...
    {
		echo "<div class='form-group form-group-last'><div class='alert alert-danger' role='alert'><div class='alert-text'>Tu ne peux pas généré / changer un passe pour ce staff, car il a un rank supérieur ou égal au tien.</div></div></div>";
    }
	elseif($userrr['rank'] < 4)
    {
		echo "<div class='form-group form-group-last'><div class='alert alert-danger' role='alert'><div class='alert-text'>Tu ne peux pas généré un passe pour un utilisateur qui n'est pas encore staff, rank le avant.</div></div></div>";
    }
    ...
    else
    {
        ...
        mysqli_query(connect::cxn_mysqli(),"INSERT INTO cms_hklogs SET type = 'Passegenerate', note = 'A attribué un passe à: ". $staffname ."', author_name = '". $myrow['username'] ."', author_id = '". $myrow['id'] ."', author_rank = '". $myrow['rank'] ."', timestamp = '". time() ."'");
		...
		echo "<div class='kt-portlet__body'><div class='form-group form-group-last'><div class='alert alert-success' role='alert'><div class='alert-text'>Le passe staff à etais généré ! Il va le recevoir par mail à <b><u></u>$staffmail</b></div></div></div></div>";
    }
	} else {
						...
						<div class="alert alert-secondary" role="alert">
							<div class="alert-icon"><i class="flaticon-warning kt-font-brand"></i></div>
						  	<div class="alert-text">
								Le nouveau passe sera généré aléatoirement. Demande-lui si le mail associé à son compte est bien valide, car le nouveau passe staff sera envoyé sur son mail. Si ce n'est pas le cas, demande-lui de mettre un mail valide dans les paramètres de son compte.
							</div>
						</div>
					</div>
