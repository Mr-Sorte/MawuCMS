...
<section>
	<div class="container">
	<div class="section-title"><h3>Existem <b><?php echo mysql_num_rows(mysql_query("SELECT * FROM cms_news WHERE category = 'sistema'")) ?></b> notícias nesta categoria</h3></div>
		<div class="row">
		
<?php $news = mysql_query("SELECT * FROM cms_news WHERE category = 'sistema' ORDER BY id DESC LIMIT 60");
