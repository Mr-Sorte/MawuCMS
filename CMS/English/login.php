...
if(isset($_POST['Username']) && isset($_POST['Password']))
{
	...
	{
		$loginerror = '<p class="alert alert-danger">Do not leave fields empty.</p>';
	}

	elseif(mysql_num_rows($Getuser) == 0)
	{
		$loginerror = '<p class="alert alert-danger">Invalid username.</p>';
	}
	
	elseif (!$captcha) 
	{
        $loginerror = '<p class="alert alert-danger">Arent you a Robo? Verify your identity.</p>';
    }
...
<head>
	...
	<title><?php echo $Holo['name']; ?>: Login</title>
	...
	<div class="container pt-3">
		...
		<form id="loginform" method="POST">
			...
			<label for="user_code">Are you Human?</label>
				...
				<input name="login" type="submit" id="wp-submit" class="button button-primary" value="Login">
			</p>
		</form>
		
		<hr class="ou my-4">

		<div class="text-center"><a href="/register" class="btn btn-lg btn-success">Create an account</a></div>
