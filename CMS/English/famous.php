...
<head>
	...
	<title><?php echo $Holo['name']; ?>: Hall</title>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul id="menu-principal" class="navbar-nav mr-auto">
			...
			<li class="menu-item menu-item-type-post_type_archive nav-item active">
				<a href="/famous" class="nav-link active">Hall</a>
			</li>
			<li class="menu-item menu-item-type-post_type_archive nav-item">
...
while($ocult = mysql_fetch_array($oculte)){ ?>
	<div class="alert alert-warning" role="alert"><b><?php echo $myrow['username']; ?></b>, you will not appear on this page because you have configured your account to be <b>Hidden</b>! <a href="/account/preferences">Click here to change</a>.</div>
<?php } ?>
		...
		<div class="card">
			<div class="card-body p-md-5">
				<div class="row">
					<div class="col-md-4">
						<h3>Rich of Diamonds</h3>
						<br><br><br>
						<div class="text-muted mb-4 mb-md-0">This category shows only the <b>Five</b> users most Rich of Diamonds in <?php echo $Holo['name']; ?> Hotel.</div>
					</div>
...
echo '							<div class="mb-3 topic-124">
								<div class="d-flex align-items-center">
									...
									<div class="w-100 d-md-flex align-items-center">
										...
										<small class="text-muted ml-md-2 mt-1"><strong><font color="#0aa8ec">'.$daimands['amount'].' Diamonds</font></strong></small>
									</div>
								</div>
							</div>';
...
?>
		...
		<div class="card">
			<div class="card-body p-md-5">
				<div class="row">
					<div class="col-md-4">
						<h3>Rich of Duckets</h3>
						<br><br><br>
						<div class="text-muted mb-4 mb-md-0">This category shows only the <b>Five</b> users most Rich of Duckets in <?php echo $Holo['name']; ?> Hotel.</div>
					</div>
					<div class="col-md-6 offset-md-2">
...
?>
		...
		<div class="card">
			<div class="card-body p-md-5">
				<div class="row">
					<div class="col-md-4">
						<h3>Rich of Credits</h3>
						<br><br><br>
						<div class="text-muted mb-4 mb-md-0">This category shows only the <b>Five</b> users most Rich of Credits in <?php echo $Holo['name']; ?> Hotel.</div>
					</div>
					<div class="col-md-6 offset-md-2">
							...
							<div class="mb-3 topic-124">
								<div class="d-flex align-items-center">
									...
									<div class="w-100 d-md-flex align-items-center">
										...
										<small class="text-muted ml-md-2 mt-1"><strong><font color="#FF9030"><?php echo $user['credits']; ?> Credits</font></strong></small>
									</div>
								</div>
							</div>
<?php } ?>
