	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3 pr-md-3 mb-4">
				<h5 class="mb-3">Categorys</h5>
				<div class="tags grey">
					<a href="/articles/promocao">Promotions</a>
					<a href="/articles/gratis">Free things</a>
					<a href="/articles/mobis">Furnis</a>
					<a href="/articles/hotel"><?php echo $Holo['name']; ?> Hotel</a>
					<a href="/articles/sistema">System</a>
				</div>
					<br>
				<h5 class="mb-3">What is this?...</h5>
				<div class="tags grey">
					<small>Here will be shown up to <b>45</b> Latest news posted, whether they are Promotions, Events or Newsletters.</small>
				</div>
			</div>
