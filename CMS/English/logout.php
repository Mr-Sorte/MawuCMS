...
<head>
	...
	<title><?php echo $Holo['name']; ?>: Logout</title>
...
<section>
	...
	<div class="text-center"> 
		...
		<p class="text-muted mb-0">We hope to see you back soon!</p>
		<hr>
		<p class="text-muted mb-0">In a moment we will get you out of here ...</p>
		<p class="text-muted mb-0"><a href="<?php echo $Holo['url']; ?>/"><button class="btn btn-danger mt-4">Exit now</button></a></p>
	</div>
