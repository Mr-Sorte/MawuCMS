...
<section>
	<div class="container">
		<h4>Formal <i class="fas fa-question-circle text-muted" data-toggle="tooltip" title="" data-original-title="The Formal Team is made up of members from Moderation to General Creation."></i></h4>
			<div class="row">
			...
			<div id="custom_widget_parceiro-2" class="widget widget_custom_widget_parceiro mb-4">
			    <div class="alert alert-secondary" role="alert"><b>Hey...</b> As we saw you are <b><?php echo $rank['rank_name']; ?></b>, we need to inform you that there are hidden ranks here, they being - <?php $isadmin = mysql_query("SELECT * FROM permissions WHERE visible = '0'");
...
<?php } ?>
			...
			<br><hr>
			<h4>Informal <i class="fas fa-question-circle text-muted" data-toggle="tooltip" title="" data-original-title="The Informal Team is made up of Ambassadors and Architects made official by the management."></i></h4>
			<div class="row">
