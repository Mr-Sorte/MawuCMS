...
if(isset($_POST['email_a']) && isset($_POST['email_n']) && isset($_POST['email_nr']))
{
    ...
    {
        $aerror = 'The email you entered already exists, put another one.';
    }
    elseif($EN != $ENR)
    {
        $aerror = 'Emails are not the same, please try again.';
    }
    elseif($EA != $myrow['mail'])
    {
        $aerror = 'The old email is not the correct one.';
    }
    else
    {
        mysql_query("UPDATE users SET mail = '". $EN ."' WHERE id = '". $myrow['id'] ."'");
        $aok = 'You have changed your Email correctly!<META http-equiv="refresh" content="2;URL=/account/correo">';
    }
}
...
if(isset($_POST['theme']))
{
    ...
    $aok = 'You have changed your Theme correctly!<META http-equiv="refresh" content="2;URL=/account/site">';
}
...
if(isset($_POST['homecolor']))
{
    ...
    $aok = 'You have changed your Home Color correctly!.<META http-equiv="refresh" content="2;URL=/account/site">';
}
...
if(isset($_POST['blockvisible']))
{
    ...
    $aok = 'You have changed your Preferences correctly!<META http-equiv="refresh" content="2;URL=/account/prefer">';
}
...
if(isset($_POST['Pass']) && isset($_POST['NPass']) && isset($_POST['RNPass']))
{
    ...
    {
        $aerror = 'Do not leave fields empty.';
    }
    elseif($NPass != $RNPass)
    {
        $aerror = 'New passwords dont match.';
    }
    elseif(md5($Pass) != $passss['password'])
    {
        $aerror = 'The old password is not correct.';
    }
    else
    {
...
<head>
	...
	<title><?php echo $Holo['name']; ?>: Settings</title>
			...
			<div class="dropdown" style="cursor:cell">
				...
				<div id="dropUser" class="d-flex align-items-center" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					...
					<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropUser">
						...
						<a class="dropdown-item active" href="/account/prefer"><i class="fas fa-cog text-muted mr-2"></i> Settings</a>
...
<?php if($_GET['item'] == "correo"){ ?>
		<h1>Settings <a href="/account/prefer" class="btn btn-warning ml-4"><font color="white">Preferences</font></a> <a href="/account/site" class="btn btn-warning ml-4"><font color="white">Site</font></a> <a href="/account/correo" class="btn btn-warning ml-4 active"><font color="white">E-mail</font></a> <a href="/account/contra" class="btn btn-warning ml-4"><font color="white">Password</font></a></h1>
<?php }elseif($_GET['item'] == "contra"){ ?>
		<h1>Settings <a href="/account/prefer" class="btn btn-warning ml-4"><font color="white">Preferences</font></a> <a href="/account/site" class="btn btn-warning ml-4"><font color="white">Site</font></a> <a href="/account/correo" class="btn btn-warning ml-4"><font color="white">E-mail</font></a> <a href="/account/contra" class="btn btn-warning ml-4 active"><font color="white">Password</font></a></h1>
<?php }elseif($_GET['item'] == "site"){ ?>
		<h1>Settings <a href="/account/prefer" class="btn btn-warning ml-4"><font color="white">Preferences</font></a> <a href="/account/site" class="btn btn-warning ml-4 active"><font color="white">Site</font></a> <a href="/account/correo" class="btn btn-warning ml-4"><font color="white">E-mail</font></a> <a href="/account/contra" class="btn btn-warning ml-4"><font color="white">Password</font></a></h1>
<?php }elseif($_GET['item'] == "prefer"){ ?>
		<h1>Settings <a href="/account/prefer" class="btn btn-warning ml-4 active"><font color="white">Preferences</font></a> <a href="/account/site" class="btn btn-warning ml-4"><font color="white">Site</font></a> <a href="/account/correo" class="btn btn-warning ml-4"><font color="white">E-mail</font></a> <a href="/account/contra" class="btn btn-warning ml-4"><font color="white">Password</font></a></h1>
<?php } ?>
	</div>
</div>
...
<?php if($_GET['item'] == "correo"){ ?>
				<div class="col-md-6">
				    <h3 class="mb-3 mt-4">Update your e-mail</h3>
...
<?php }elseif($_GET['item'] == "contra"){ ?>
				<div class="col-md-6">
				    <h3 class="mb-3 mt-4">Change your Password</h3>
...
<?php }elseif($_GET['item'] == "site"){ ?>
				<div class="col-md-6">
				    <h3 class="mb-3 mt-4">Change how you see our Hotel</h3>
...
while($actual = mysql_fetch_assoc($actuals)){ ?>
				    <h3 class="mb-3 mt-4">Your Preferences</h3>
        ...
        ?>
					...
					<form action="" id="adduser" method="post">
						...
						<div class="form-group form-display_name">
							<label for="display_name">Profile Visibility <i class="fas fa-question-circle text-muted" data-toggle="tooltip" title="" data-original-title="If you choose Not to have a Profile, neither will you be able to view your own <?php echo $Holo['name']; ?> Home."></i></label>
...
while($actual = mysql_fetch_assoc($actuals)){ ?>
							<select class="custom-select" name="blockvisible" id="blockvisible">
								<option value="1" selected="selected">Everyone can see my profile</option>
								<option value="0">I don't want a profile</option>
							</select>
<?php } ?>
<?php $actuals = mysql_query("SELECT * FROM users WHERE visible = '0' AND id = '". $myrow['id'] ."'");
while($actual = mysql_fetch_assoc($actuals)){ ?>
							<select class="custom-select" name="blockvisible" id="blockvisible">
								<option value="1">Everyone can see my profile</option>
								<option value="0" selected="selected">I don't want a profile</option>
							</select>
<?php } ?>
						</div>
