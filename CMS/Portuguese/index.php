...
<?php } ?>
    ...
    <div class="alert alert-secondary" role="alert"><b>Atenção!</b> Se você deseja ler uma de nossas notícias ou ter acesso a mais notícias, primeiramente precisa estar conectado em uma conta.</div>
		</div>
