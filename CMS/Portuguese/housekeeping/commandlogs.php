	...
	<div class="kt-portlet__body">
		<div id="kt_table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    ...
                    <div class="form-group">
                        <label>Aqui estão os últimos <b>550</b> Registros de Comandos usados dentro do Hotel.</label>
                    </div>
...
<tr role="row">
	...
	<th class="sorting" tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 99.25px;">Data de Uso</th>
	<th class="sorting" tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 157.25px;">Comando usado</th>
...
<?php $commandlogs = mysql_query("SELECT * FROM commandlogs ORDER BY id DESC LIMIT 550");
while($commandlog = mysql_fetch_array($commandlogs)){
$user = mysql_fetch_assoc($user = mysql_query("SELECT * FROM users WHERE id = '".$commandlog['user_id']."'"));
?>	
<tr role="row">
	...
	<td><?php echo date('d/m', $commandlog['timestamp']); ?> de <?php echo date('Y', $commandlog['timestamp']); ?></td>
	<td><?php echo $commandlog['params']; ?></td>
	<td>
		<span class="kt-badge  kt-badge--<?php if($commandlog['succes'] == 'yes') { echo 'success'; } else { echo 'danger'; } ?> kt-badge--inline kt-badge--pill"><?php if($commandlog['succes'] == 'yes') { echo 'Sucesso'; } else { echo 'Erro'; } ?></span>
	</td>
</tr>
<?php } ?>
